Здравствуйте ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif)Меня зовут Бондарева Мария
=======================================================================================================================================

Я бекенд разработчик на python
----------------------------
* Пишу проекты с использованием фреймворков Django, Django Rest Framework и FastAPI
* 🌍  Нахожусь в Россия, г. Краснодар
* ✉️  Написать по электронной почте [mnikitina2001@gmail.com](mailto:mnikitina2001@gmail.com)
